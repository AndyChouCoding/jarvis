        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            <h1 className="text-4xl font-bold tracking-tight text-zinc-900 dark:text-zinc-50 sm:text-6xl">
              Jarvis: Your Second Brain
            </h1>
            <p className="mt-6 text-lg leading-8 text-zinc-600 dark:text-zinc-300">
              Automate your workflow, analyze complex data, and generate code with
              intelligent agents designed to amplify your productivity.
            </p>
            <div className="mt-10 flex items-center justify-center gap-x-6">
              ...
              <Link
                href="#"
                className="text-sm font-semibold leading-6 text-zinc-900 dark:text-zinc-100 flex items-center gap-1"
              >
